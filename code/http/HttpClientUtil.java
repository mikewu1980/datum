...
public class HttpClientUtil {
	 ...
	 * @return
	 */
	private static String submitRequest(HttpUriRequest request, String charset) {
	 ...
	 * @return
	 */
	public static String postJsonBody(String url, String data, String characterSet, int timeout) {
		// 入参检查
	 ...
	 * @return
	 */
	public static String postForm(String url, List<BasicNameValuePair> parameters, String characterSet, int timeout) {
		// 入参检查
		if (StringUtils.isBlank(url)) {
			return null;
		}

		List<BasicNameValuePair> params = parameters;
		if (null == params) {
	 ...
	 * @return
	 */
	public static String postAttachment(String url, List<BasicNameValuePair> parameters,
			List<FileNameValuePair> attachments, String characterSet, int timeout) {
		// 入参检查
		if (StringUtils.isBlank(url)) {
			return null;
		}
		...
		List<FileNameValuePair> files = attachments;
		if (null == files) {
	...
	public static String convertUrl4Get(String url, List<BasicNameValuePair> params, String characterSet) {
		// 入参检查
		if (StringUtils.isBlank(url)) {
			return url;
		}
		...
		for (BasicNameValuePair item : params) {
			...
			try {
				uri.append(URLEncoder.encode(value, charset));
	 ...
	 * @return
	 */
	public static String convertUrl4Get(String url, List<BasicNameValuePair> params) {
	 ...
	 * @return
	 */
	public static String invokeGet(String url, List<BasicNameValuePair> parameters, String characterSet, int timeout) {
		// 入参检查
		if (StringUtils.isBlank(url)) {
			return null;
		}
	...
	public static byte[] downloadAttachment(String url, List<BasicNameValuePair> parameters, int timeout) {
		// 入参检查
		if (StringUtils.isBlank(url)) {
			return null;
		}
	...
	public static String postJsonBody(String url, String json, String charset) {
	...
	public static String postForm(String url, List<BasicNameValuePair> params, String charset) {
		return postForm(url, params, charset, defaultTimeout);
	}

	public static String postForm(String url, List<BasicNameValuePair> params, int timeout) {
		return postForm(url, params, defaultCharset, timeout);
	}

	public static String postForm(String url, List<BasicNameValuePair> params) {
		return postForm(url, params, defaultCharset, defaultTimeout);
	}

	public static String postAttachment(String url, List<BasicNameValuePair> parameters,
			List<FileNameValuePair> attachments, String characterSet) {
		return postAttachment(url, parameters, attachments, characterSet, defaultTimeout);
	}

	public static String postAttachment(String url, List<BasicNameValuePair> parameters,
			List<FileNameValuePair> attachments, int timeout) {
		return postAttachment(url, parameters, attachments, defaultCharset, timeout);
	}

	public static String postAttachment(String url, List<BasicNameValuePair> parameters,
			List<FileNameValuePair> attachments) {
		return postAttachment(url, parameters, attachments, defaultCharset, defaultTimeout);
	}

	public static String invokeGet(String url, List<BasicNameValuePair> params, String charset) {
		return invokeGet(url, params, charset, defaultTimeout);
	}

	public static String invokeGet(String url, List<BasicNameValuePair> params, int timeout) {
		return invokeGet(url, params, defaultCharset, timeout);
	}

	public static String invokeGet(String url, List<BasicNameValuePair> params) {
	...
	public static byte[] downloadAttachment(String url, List<BasicNameValuePair> parameters) {
	...
	public static void queryIpRegion() {
		...
		try {
			...
			for (String ip : ips) {
				...
				String response = HttpClientUtil.invokeGet(url, params, "gb2312");
