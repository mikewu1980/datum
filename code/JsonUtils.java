...
public class JsonUtils {
	 ...
	 * <p />
	 * <strong>该方法转换发生错误时，不会抛出任何异常。若发生错误时，普通对象返回 <code>"{}"</code>； 集合或数组对象返回 <code>"[]"</code> </strong>
	 * 
	 * @param target
	 *            目标对象。
	 * @param targetType
	...
	public static String toJson(Object target, Type targetType, boolean isSerializeNulls, Double version,
		...
		// 注册JAXBElement类型适配器
		// builder.registerTypeAdapter(JAXBElement.class, new
		// JsonSerializer<JAXBElement>() {
		// @Override
		// public JsonElement serialize(JAXBElement el, Type type,
		// JsonSerializationContext context) {
		// if (el != null && el.getValue() != null) {
		// return new JsonPrimitive(el.getValue().toString());
		// }
	...
	public static String toJson(Object target, Type targetType, boolean isSerializeNulls,
		...
		return toJson(target, targetType, isSerializeNulls, null, null, excludesFieldsWithoutExpose);
	}
