...
public class JsonpFastJsonJsonView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		if (value instanceof ResponseEntity) {
			String jsonpFunction = ((ResponseEntity) value).getJsonpFunction();
			if (jsonpFunction != null) {
				StringBuilder textBuilder = new StringBuilder(text.length() + jsonpFunction.length());
				text = textBuilder.append(jsonpFunction).append("(").append(text).append(");").toString();
			}
		}
	...
	protected Object filterModel(Map<String, Object> model) {
		...
		Set<String> renderedAttributes = null;
		if (CollectionUtils.isNotEmpty(this.renderedAttributes)) {
